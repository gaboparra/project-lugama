...
export default function GamePage() {
  ...
  const {
    ...
    guessDisabled, suggestions, isPlaying, currentTime,
    volume, audioRef, TIME_LIMITS, MAX_ATTEMPTS,
    loadGenres, loadSong, changeGenre, check, skip,
    search, genre, togglePlay, changeVolume,
    difficulty, changeDifficulty, gameOver,
    artist, artists, loadArtists, changeArtist,
