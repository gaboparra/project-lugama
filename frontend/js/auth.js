...
window.showRegister = function () {
  ...
  if (window.isRegisterMode) {
    ...
    toggleLink.innerHTML =
      '¿Ya tenés cuenta? <a href="#" onclick="showRegister()">Logueate</a>';
  } else {
    ...
    toggleLink.innerHTML =
      '¿No tenés cuenta? <a href="#" onclick="showRegister()">Registrate acá</a>';
  }
};
...
window.handleRegister = async function () {
  ...
  try {
    ...
    if (!res.ok) {
      ...
      showAuthError(
        data.error === "User or email already in use"
